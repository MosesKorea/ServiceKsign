	...
	<div class="main-inner">
		<div class="container">
			...
			<div class="col-md-9">
					...
					<div class="panel-heading"><h2>유지관리 생성</h2></div>
								...
								<div class="col-xs-12">
									<div class="col-md-12">
										...
										<div class="form-group">
											<div class="col-md-1 "></div>
											<div class="col-md-4">
												<label class="control-label">기존고객</label> <input type="radio" required="required" class="old_customer" placeholder="Enter First Name" /> <label class="control-label">신규고객</label>
												<input type="radio" required="required" class="new_customer" placeholder="Enter First Name" />
											</div>
										...
										<!-- 고객정보 입력 -->
										<%@ include file="../project/customer/customer_create.jsp" %>
							...
							<div class="row setup-content" id="step-3">
								<div class="col-xs-12">
									<div class="col-md-12">
										...
										<!-- 고객 요구사항 입력 -->
										<%@ include file="../project/etl/etl_list.jsp" %>
										<div style="visibility: hidden;"><input  type="text" required="required" class="form-control" placeholder="넘기기" value="sss"/></div>
										<!-- 입력완료 -->
										<div class="row" style="padding-top: 10px; padding-bottom: 30px">
											<button class="btn btn-primary nextBtn btn-lg pull-right" type="button">Next</button>
							...
							<div class="row setup-content" id="step-4">
								<div class="col-xs-12">
									<div class="col-md-12">
										...
										<!-- 입력정보 확인 -->
										<%@ include file="../project/customer_demands/customer_demands_list.jsp" %>
										<div style="visibility: hidden;"><input  type="text" required="required" class="form-control" placeholder="넘기기" value="sss"/></div>
										<!-- 입력완료 -->
										<div class="row" style="padding-top: 10px; padding-bottom: 30px">
											<button class="btn btn-success btn-lg pull-right" type="submit">유지보수 등록</button>
										</div>
									</div>
								</div>
							</div>
