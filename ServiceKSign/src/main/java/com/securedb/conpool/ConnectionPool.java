...
public final class ConnectionPool {
 ...
 // Storage for the allocated connections.
	...
	// Create some connections.
		...
		System.out.println(">>>>> Connection Pool Constructor:"+this);
    }
	...
	private void loadConf() {
		...
		InputStream in= cl.getResourceAsStream("spring/data-access.properties");
...
/*		this.driver="oracle.jdbc.driver.OracleDriver";
		this.url = "jdbc:oracle:thin:@192.168.248.128:1521:testdb";
		this.user = "dbsecag";
		this.password = "dbsecag";
		this.initialCons = 2;
		this.maxCons = 3;
		this.block = true;
		this.timeout = 10000;
*/
		...
		this.driver=(String)p.get("jdbc.driverClassName");
		System.out.println(driver);
		this.user = (String)p.get("jdbc.username");
		System.out.println(user);
		this.password = (String)p.get("jdbc.password");
		System.out.println(password);
		this.initialCons = Integer.parseInt((String)p.get("jdbc.initialCons"));
		System.out.println(initialCons);
		this.maxCons = Integer.parseInt((String)p.get("jdbc.maxCons"));
		System.out.println(maxCons);
		this.block = new Boolean((String)p.get("jdbc.block")).booleanValue();
		System.out.println(block);
		this.timeout = Long.parseLong((String)p.get("jdbc.timeout"));
